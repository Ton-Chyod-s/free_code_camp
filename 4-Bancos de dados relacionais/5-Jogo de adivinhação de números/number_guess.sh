...
# Verifica se o nome de usuário contém apenas letras e sublinhados
if [[ $username =~ ^[a-zA-Z0-9_]{0,22}+$ ]]; then
  ...
  echo "Invalid username. Username cannot contain numbers, special characters or more 22 caracter."
  exit
fi
