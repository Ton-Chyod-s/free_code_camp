...
if [[ ! -z $ELEMENT ]]; then
  ...
  echo "The element with atomic number $ATOMIC_NUMBER is $NAME_ELEMENT (H). It's a nonmetal, with a mass of 1.008 amu. Hydrogen has a melting point of -259.1 celsius and a boiling point of -252.9 celsius."
fi
